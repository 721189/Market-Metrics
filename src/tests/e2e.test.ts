    ...
    evidence_pool: [
      {
        ...
        provenance_type: 'OBSERVED',
        created_at: new Date().toISOString(),
        source_url: 'https://example.test/src_e2e_1',
        source_domain: 'example.test',
        citation_number: 1,
        statement: 'roll-to-roll manufacturing compatibility for solid electrolytes',
        extracted_quote: 'roll-to-roll manufacturing compatibility for solid electrolytes',
        relevance_score: 0,
        verification_status: 'UNVERIFIED',
        confidence: 98,
        provenance: {
          document_text: 'roll-to-roll manufacturing compatibility for solid electrolytes',
          document_hash: '',
          source_url: 'https://example.test/src_e2e_1',
          retrieved_at: new Date().toISOString(),
